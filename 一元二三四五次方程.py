    ...
    if a == 0:
        ...
        if L==M==N==P==0:#(1)
            ...
            if det1 >0:
                ...
                x2 = (-12*b*E+4*F+(y1**(1/3)+y2**(1/3)))/(60*a*E) + (3**(1/2)*(y1**(1/2)-y2**(1/2)))/(60*a*E)*j

                x3 = (-12*b*E+4*F+(y1**(1/3)+y2**(1/3)))/(60*a*E) - 3**(1/2)*(y1**(1/2)-y2**(1/2))/(60*a*E)*j
            ...
            if dedt2 > 0:
                ...
                x2 = (-b+(1-5**(1/2))*(y1**(1/5)+y2**(1/5))/4)/(5*a)+(10+2*5**(1/2))*(y1**(1/5)-y2**(1/5))/(20*a)*j

                x3 = (-b+(1-5**(1/2))*(y1**(1/5)+y2**(1/5))/4)/(5*a)-(10+2*5**(1/2))*(y1**(1/5)-y2**(1/5))/(20*a)*j

                x4 = (-b+(1+5**(1/2))*(y1**(1/5)+y2**(1/5))/4)/(5*a)+(10-2*5**(1/2))*(y1**(1/5)-y2**(1/5))/(20*a)*j

                x5 = (-b+(1+5**(1/2))*(y1**(1/5)+y2**(1/5))/4)/(5*a)-(10-2*5**(1/2))*(y1**(1/5)-y2**(1/5))/(20*a)*j
                ...
                x2 = (-b+((1-5**(1/2))*math.cos(sita/5)+math.sin(sita/5)*(10+2*5**(1/2))**(1/2))/2*L**(1/2))/(5*a)

                x3 = (-b+((1-5**(1/2))*math.cos(sita/5)-math.sin(sita/5)*(10+2*5**(1/2))**(1/2))/2*L**(1/2))/(5*a)

                x4 = (-b+((1+5**(1/2))*math.cos(sita/5)+math.sin(sita/5)*(10-2*5**(1/2))**(1/2))/2*L**(1/2))/(5*a)

                x5 = (-b+((1+5**(1/2))*math.cos(sita/5)-math.sin(sita/5)*(10-2*5**(1/2))**(1/2))/2*L**(1/2))/(5*a)
            ...
            x2 = (-b+(1-5**(1/2))*z1/4+(1+5**(1/2))*z2/4)/(5*a)+(z1*(10+2*5**(1/2))**(1/2)/4+z2*(10-2*5**(1/2))**(1/2)/4)/(5*a)*j

            x3 = (-b+(1-5**(1/2))*z1/4+(1+5**(1/2))*z2/4)/(5*a)-(z1*(10+2*5**(1/2))**(1/2)/4+z2*(10-2*5**(1/2))**(1/2)/4)/(5*a)*j

            x4 = (-b+(1+5**(1/2))*z1/4+(1-5**(1/2))*z2/4)/(5*a)+(z1*(10-2*5**(1/2))**(1/2)/4+z2*(10+2*5**(1/2))**(1/2)/4)/(5*a)*j

            x5 = (-b+(1+5**(1/2))*z1/4+(1-5**(1/2))*z2/4)/(5*a)-(z1*(10-2*5**(1/2))**(1/2)/4+z2*(10+2*5**(1/2))**(1/2)/4)/(5*a)*j
